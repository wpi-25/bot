...
const commandFiles = readdirSync('./triggers/commands').filter(file=>file.endsWith('.ts'));
...
const triggerFiles = readdirSync('./triggers/triggers').filter(file=>file.endsWith('.ts'));
...
const reactionFiles = readdirSync('./triggers/reactions').filter(file=>file.endsWith('.ts'));
