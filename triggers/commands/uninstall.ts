        ...
        switch (type) {
            case 'command':
                ...
                let commandSuccess = new MessageEmbed()
                    .setColor('#4caf50')
                    .setDescription(`Command \`${command.name}\` was uninstalled!`);
            ...
            case 'trigger':
                ...
                let triggerSuccess = new MessageEmbed()
                    .setColor('#4caf50')
                    .setDescription(`Trigger \`${commandName}\` was uninstalled!`);
            ...
            case 'reaction':
                ...
                let reactionSuccess = new MessageEmbed()
                    .setColor('#4caf50')
                    .setDescription(`Reaction command \`${commandName}\` was uninstalled!`);
